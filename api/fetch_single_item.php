...
try {
    ...
    $sql = "SELECT SHIPFLAG, branch, docno, DOCDATE, CUSTNAME, user_lname, dg_lname, cd_code, cd_name, ct_lname, brand, code, lname, location_code, location, SNAME, LName_unit, qty, REMARK, UNITPRICE, NETAMOUNT, dim5_code, dim5_name, delivery_status, last_update, create_at, COALESCE(received_qty_total, 0) AS received_qty_total, COALESCE(received_count, 0) AS received_count
            ...
            ORDER BY last_update DESC, docdate DESC, sub_id ASC, Lname_unit ASC, UNITPRICE ASC, cd_code ASC
            LIMIT 1";
